...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('report-types.edit', $reportType) }}" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-indigo-600 text-white text-sm font-medium hover:bg-indigo-700 shadow-sm">
        ...
        <div x-show="showAddSection" x-cloak class="mb-5 p-4 rounded-lg bg-gray-50 border border-gray-200">
            <form action="{{ route('report-types.sections.store', $reportType) }}" method="POST" class="space-y-3">
                ...
                <div class="flex justify-end gap-2">
                    ...
                    <button type="submit" class="px-3 py-1.5 rounded-lg bg-indigo-600 text-white text-xs font-medium hover:bg-indigo-700">Simpan Seksi</button>
                </div>
            </form>
        </div>
                ...
                <div x-show="editSection" x-cloak class="px-4 py-3 bg-yellow-50 border-b border-gray-200">
                    <form action="{{ route('report-types.sections.update', [$reportType, $section]) }}" method="POST" class="space-y-3">
                        ...
                        <div class="flex justify-end gap-2">
                            ...
                            <button type="submit" class="px-3 py-1.5 rounded-lg bg-indigo-600 text-white text-xs font-medium hover:bg-indigo-700">Simpan</button>
                        </div>
                    </form>
                </div>
                    ...
                    <div x-show="showLocForm" x-cloak class="mb-3 p-3 rounded-lg bg-blue-50 border border-blue-100">
                        <form action="{{ route('report-types.sections.locations.store', [$reportType, $section]) }}" method="POST" class="space-y-3">
                            ...
                            <div class="flex justify-end gap-2">
                                ...
                                <button type="submit" class="px-3 py-1 rounded bg-indigo-600 text-white text-xs font-medium hover:bg-indigo-700">Simpan</button>
                            </div>
                        </form>
                    </div>
