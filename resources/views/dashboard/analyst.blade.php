...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="flex items-center justify-between px-5 py-3.5 border-b border-gray-100">
            ...
            <a href="{{ route('reports.index', ['status' => 'pending']) }}" class="text-xs text-sky-600 hover:text-sky-800 font-medium">Lihat semua →</a>
        </div>
        <div class="divide-y divide-gray-50">
            ...
            <div class="flex items-center justify-between px-5 py-3 hover:bg-gray-50 transition-colors">
                ...
                <div class="ml-3 flex-shrink-0 flex items-center gap-1.5">
                    <a href="{{ route('reports.preview', $item) }}"
                    ...
                    <button type="button"
                            onclick="confirmMulai('{{ route('reports.fill', $item) }}', '{{ addslashes($item->product_name) }}', '{{ addslashes($item->batch_number) }}')"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="flex items-center justify-between px-5 py-3.5 border-b border-gray-100">
            ...
            <a href="{{ route('reports.index', ['status' => 'monitoring']) }}" class="text-xs text-sky-600 hover:text-sky-800 font-medium">Lihat semua →</a>
        </div>
        <div class="divide-y divide-gray-50">
            ...
            <div class="flex items-center justify-between px-5 py-3 hover:bg-gray-50 transition-colors">
                ...
                @if ($isMine)
                <a href="{{ route('reports.fill', $item) }}"
                ...
                <div class="ml-3 flex-shrink-0 flex items-center gap-1.5">
                    ...
                    <button type="button"
                            onclick="confirmMulai('{{ route('reports.fill', $item) }}', '{{ addslashes($item->product_name) }}', '{{ addslashes($item->batch_number) }}', 'resume_monitoring')"
                            class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-sky-500 text-white text-xs font-medium hover:bg-sky-600 transition-colors">
                        <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
                        </svg>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="flex items-center justify-between px-5 py-3.5 border-b border-gray-100">
            ...
            <a href="{{ route('reports.index', ['status' => 'reading']) }}" class="text-xs text-sky-600 hover:text-sky-800 font-medium">Lihat semua →</a>
        </div>
        <div class="divide-y divide-gray-50">
            ...
            <div class="flex items-center justify-between px-5 py-3 hover:bg-gray-50 transition-colors">
                ...
                <div class="ml-3 flex-shrink-0 flex items-center gap-1.5">
                    ...
                    <button type="button"
                            onclick="confirmMulai('{{ route('reports.fill', $item) }}', '{{ addslashes($item->product_name) }}', '{{ addslashes($item->batch_number) }}', 'reading')"
