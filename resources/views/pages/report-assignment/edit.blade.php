...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <form action="{{ route('report-assignment.update', $reportAssignment) }}" method="POST" class="space-y-5">
            @csrf
            @method('PUT')

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Nama Produk <span class="text-red-500">*</span></label>
                <input type="text" name="product_name" value="{{ old('product_name', $reportAssignment->product_name) }}"
            ...
            <div>
                ...
                <input type="text" name="batch_number" value="{{ old('batch_number', $reportAssignment->batch_number) }}"
            ...
            <div>
                ...
                <select name="report_type_id"
                    ...
                    @foreach ($reportTypes as $rt)
                        <option value="{{ $rt->id }}" {{ $reportAssignment->report_type_id == $rt->id ? 'selected' : '' }}>
