...
<div class="space-y-4">
    ...
    <form method="POST" action="{{ route('supervisor.reports.save', $report) }}" class="space-y-4">
    @csrf
    @endif
    @if ($needsAirSampler)
        ...
        <div class="flex flex-col gap-3">
            ...
            <div class="rounded-xl border-2 border-orange-200 bg-orange-50 p-4 flex flex-col gap-3">
                ...
                <div class="flex gap-2">
                    <select id="return-analyst-select"
...
function openConfirmModal(action) {
    ...
    if (action === 'approve') {
        ...
        const analystVal = document.getElementById('return-analyst-select').value;
        if (!analystVal) {
        ...
        document.getElementById('modal-returned-to-user-id').value = analystVal;
